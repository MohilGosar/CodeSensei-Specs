...
requirements.md: This document outlines the specific features and user stories we committed to building.

design.md: This covers the technical blueprint, including data schemas and the communication between the extension and the analysis engine.
